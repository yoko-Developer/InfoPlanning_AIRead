package jp.co.ariseinnovation.setfixedassetaccountcode.consts;
...
public final class CommonConsts {
    ...
    private final static String[] CONTAIN_CHECK_ARRAY = { "合計", "小計", "計" };
    ...
    public final static boolean isNotContain(String val) {
        ...
        public final static boolean isNotContain(String val, List<String> checkValList) {
        for (String checkVal : checkValList) {
            if (val.contains(checkVal)) {
                return false;
            }
        }
